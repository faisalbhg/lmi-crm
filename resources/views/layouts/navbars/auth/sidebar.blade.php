<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{asset('img/logos/logo.svg')}}" class="navbar-brand-img w-100" style="max-height: 3rem;" alt="...">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if(Session::get('user')->isadmin || Session::get('user')->CRMSettings)
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'crm' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <i class="fab fa-digital-ocean text-lg opacity-10 {{ in_array(request()->route()->getName(),['crm']) ? 'text-white' : 'text-dark' }}" aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">CRM</span>
                </a>
            </li>
            @endif
            @if(Session::get('user')->isadmin || Session::get('user')->usertype == 7  || Session::get('user')->usertype == 6)
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Sample</h6>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'samples' ? 'active' : '' }}"
                    href="{{ route('samples') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-vials text-lg opacity-10 {{ in_array(request()->route()->getName(),['samples']) ? 'text-white' : 'text-dark' }}" aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Samples</span>
                </a>
            </li>
            @endif
            @if(Session::get('user')->isadmin  || Session::get('user')->feedbackSettings)
            <li class="nav-item mt-2">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#usersMenu" class="nav-link {{ in_array(request()->route()->getName(),['location-solution','ls-order-status']) ? 'active' : ' ' }}" aria-controls="laravelExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-user ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['location-solution','ls-order-status']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1"> Location Solutions </span>
                </a>
                <div class="collapse {{ in_array(request()->route()->getName(),['location-solution','ls-order-status']) ? 'show' : '' }}" id="usersMenu" style="">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item {{ Route::currentRouteName() == 'location-solution' ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('location-solution') }}">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Orders Attachments </span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::currentRouteName() == 'ls-order-status' ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('ls-order-status') }}">
                                <span class="sidenav-mini-icon"> D </span>
