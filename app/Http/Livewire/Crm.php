    ...
    public function exportExcelCRM()
    {
        $crmQuery = CrmLogs::select('crms.id',
            ...
            \DB::raw('(CASE 
                ...
                WHEN crms.related_to = 8 THEN "Gul Food"
